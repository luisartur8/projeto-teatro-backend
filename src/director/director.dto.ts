...
export class DirectorDto {
  ...
  @IsString({ message: 'O campo specialty deve ser do tipo string' })
  @IsNotEmpty({ message: 'O campo specialty é obrigatório' })
  @MinLength(4, { message: 'O campo specialty deve ter no mínimo 4 caracteres' })
  @MaxLength(100, { message: 'O campo specialty deve ter no máximo 100 caracteres' })
  specialty: string;

  @IsString({ message: 'O campo experience deve ser do tipo string' })
  @IsNotEmpty({ message: 'O campo experience é obrigatório' })
  @MinLength(4, { message: 'O campo experience deve ter no mínimo 4 caracteres' })
  @MaxLength(100, { message: 'O campo experience deve ter no máximo 100 caracteres' })
  experience: string;
